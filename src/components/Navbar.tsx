...
import { LogOut, BookOpen, GraduationCap, FileText, Bell, LayoutDashboard, Download, Laptop, Smartphone, HelpCircle } from 'lucide-react';
...
export default function Navbar({ user, role, activeSection, setActiveSection, onInstallClick, showInstallButton }: NavbarProps) {
